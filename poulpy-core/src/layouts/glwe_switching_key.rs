...
use crate::layouts::{
    Base2K, Degree, Dnum, Dsize, GGLWE, GGLWEInfos, GGLWEMut, GGLWERef, GGLWEToMut, GGLWEToRef, GLWEInfos, GLWEMut, GLWERef,
...
pub type GLWESwitchingKeyOwned = GLWESwitchingKey<Vec<u8>>;
