...
use crate::layouts::{
    ...
    GGLWEToMut, GLWEInfos, GLWESwitchingKeyDegrees, GLWESwitchingKeyDegreesMut, LWEInfos, LWESwitchingKey, Rank, TorusPrecision,
...
pub type LWESwitchingKeyCompressedOwned = LWESwitchingKeyCompressed<Vec<u8>>;
