...
use crate::layouts::{
    ...
    GGLWEToMut, GLWEInfos, GLWESwitchingKeyDegrees, GLWESwitchingKeyDegreesMut, LWEInfos, LWEToGLWEKey, Rank, TorusPrecision,
...
pub type LWEToGLWEKeyCompressedOwned = LWEToGLWEKeyCompressed<Vec<u8>>;
