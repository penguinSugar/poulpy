...
use crate::{
    ...
    encryption::SIGMA,
    layouts::{
        GLWE, GLWECompressedOwned, GLWELayout, GLWEOwned, GLWEPlaintext, GLWEPlaintextLayout, GLWEPlaintextOwned, GLWEPublicKey,
        GLWEPublicKeyOwned, GLWEPublicKeyPreparedFactory, GLWEPublicKeyPreparedOwned, GLWESecret, GLWESecretOwned,
    ...
    Scratch<BE>: ScratchAvailable + ScratchTakeCore<BE>,
{
    ...
    for rank in 1_usize..3 {
        ...
        let mut ct: GLWEOwned = GLWE::alloc_from_infos(&glwe_infos);
        let mut pt_want: GLWEPlaintextOwned = GLWEPlaintext::alloc_from_infos(&pt_infos);
        ...
        let mut sk: GLWESecretOwned = GLWESecret::alloc_from_infos(&glwe_infos);
    ...
    Scratch<BE>: ScratchAvailable + ScratchTakeCore<BE>,
{
    ...
    for rank in 1_usize..3 {
        ...
        let mut ct_compressed: GLWECompressedOwned = GLWECompressed::alloc_from_infos(&glwe_infos);
    ...
    Scratch<BE>: ScratchAvailable + ScratchTakeCore<BE>,
{
    ...
    for rank in 1_usize..3 {
        ...
        let pt: GLWEPlaintextOwned = GLWEPlaintext::alloc_from_infos(&glwe_infos);
    ...
    Scratch<BE>: ScratchAvailable + ScratchTakeCore<BE>,
{
    ...
    for rank in 1_usize..3 {
        ...
        let mut ct: GLWEOwned = GLWE::alloc_from_infos(&glwe_infos);
        let mut pt_want: GLWEPlaintextOwned = GLWEPlaintext::alloc_from_infos(&glwe_infos);
        ...
        let mut pk: GLWEPublicKeyOwned = GLWEPublicKey::alloc_from_infos(&glwe_infos);
        pk.generate(module, &sk_prepared, &mut source_xa, &mut source_xe);

        module.vec_znx_fill_uniform(base2k, &mut pt_want.data, 0, &mut source_xa);

        let mut pk_prepared: GLWEPublicKeyPreparedOwned<BE> = GLWEPublicKeyPrepared::alloc_from_infos(module, &glwe_infos);
