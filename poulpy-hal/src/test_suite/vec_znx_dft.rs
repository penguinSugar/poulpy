...
use crate::{
    ...
    layouts::{
        Backend, DataViewMut, DigestU64, FillUniform, Module, ScratchOwned, VecZnx, VecZnxBigOwned, VecZnxDftOwned, VecZnxOwned,
    },
    source::Source,
};
    ...
    ScratchOwned<BT>: ScratchOwnedAlloc<BT> + ScratchOwnedBorrow<BT>,
{
    ...
    for a_size in [1, 2, 3, 4] {
        ...
        for res_size in [1, 2, 3, 4] {
            let mut res: VecZnxOwned = VecZnx::alloc(n, cols, a_size);
