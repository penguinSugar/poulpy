...
use crate::{
    ...
    layouts::{
        Backend, DataViewMut, DigestU64, FillUniform, Module, ScalarZnx, ScalarZnxOwned, ScratchOwned, SvpPPolOwned, VecZnx,
        VecZnxDftOwned, VecZnxOwned,
    },
    source::Source,
};
    ...
    ScratchOwned<BT>: ScratchOwnedAlloc<BT> + ScratchOwnedBorrow<BT>,
{
    ...
    let mut scalar: ScalarZnxOwned = ScalarZnx::alloc(n, cols);
